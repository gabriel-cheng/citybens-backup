...
if ( ! class_exists( 'bizcare_Demo' ) ) {
	...
	class bizcare_Demo {
		...
		/**
		 * Singleton instance of bizcare_Demo.
		 *
		 * @var bizcare_Demo $instance bizcare_Demo instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof bizcare_Demo ) ) {
				self::$instance = new bizcare_Demo();
