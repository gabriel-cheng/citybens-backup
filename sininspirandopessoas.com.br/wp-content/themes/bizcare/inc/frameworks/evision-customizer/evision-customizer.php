...
if ( ! class_exists( 'Bizcare_Evision_Customizer' ) ){
    /**
     ...
     * @since 1.0.0
     */
    class Bizcare_Evision_Customizer{
        /*Basic variables for class*/

        /**
         * Bizcare_Evision_Customizer class instance.
         *
         * @see instance()
         * @var object
         * @access protected
    ...
    } /*END class Bizcare_Evision_Customizer*/

    /*Initialize class after theme setup*/
    add_action( 'after_setup_theme', array ( Bizcare_Evision_Customizer::instance(), 'init' ));
...
}/*END if(!class_exists('Bizcare_Evision_Customizer'))*/
